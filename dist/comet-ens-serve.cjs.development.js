...
var ccipReadServer = require('@chainlink/ccip-read-server');
var ethers = require('ethers');
var utils = require('ethers/lib/utils');
var client = require('@prisma/client');
var extensionAccelerate = require('@prisma/extension-accelerate');
var IResolverService_json = require('@ensdomains/offchain-resolver-contracts/artifacts/contracts/OffchainResolver.sol/IResolverService.json');
var Resolver_json = require('@ensdomains/ens-contracts/artifacts/contracts/resolvers/Resolver.sol/Resolver.json');
...
var prismaClientSingleton = function prismaClientSingleton() {
  return new client.PrismaClient().$extends(extensionAccelerate.withAccelerate());
};
...
var Resolver = /*#__PURE__*/new ethers.ethers.utils.Interface(Resolver_json.abi);
    ...
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          ...
          if (!(ethers.ethers.utils.nameprep(name) !== name)) {
            _context6.next = 3;
            break;
          }
          throw new Error('Name must be normalised');
        case 3:
          if (!(ethers.ethers.utils.namehash(name) !== args[0])) {
            _context6.next = 5;
            break;
          }
...
function makeServer(signer) {
  var server = new ccipReadServer.Server();
  server.add(IResolverService_json.abi, [{
    type: 'resolve',
    func: function () {
        ...
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            ...
            case 4:
              ...
              messageHash = ethers.ethers.utils.solidityKeccak256(['bytes', 'address', 'uint64', 'bytes32', 'bytes32'], ['0x1900', request == null ? void 0 : request.to, validUntil, ethers.ethers.utils.keccak256((request == null ? void 0 : request.data) || '0x'), ethers.ethers.utils.keccak256(result)]);
              sig = signer.signDigest(messageHash);
              sigData = utils.hexConcat([sig.r, sig._vs]);
...
//   );
// }
var address = /*#__PURE__*/ethers.ethers.utils.computeAddress(privateKey);
var signer = /*#__PURE__*/new ethers.ethers.utils.SigningKey(privateKey);
var app = /*#__PURE__*/makeApp(signer, '/');
console.log("Serving on port " + port + " with signing address " + address);
app.listen(port);
//# sourceMappingURL=comet-ens-serve.cjs.development.js.map
